    ...
    unsigned int out_streams)
{
    ...
    else if (implementation == "GPS_L1_CA_Neural_Residual_Tracking")
        {
            return std::make_unique<GpsL1CaNeuralResidualTracking>(configuration, role, in_streams, out_streams);
        }
